...
<div className='w-screen h-screen absolute top-0 left-0 flex justify-between items-center px-24'>
  <div className='flex flex-col gap-4 text-white w-3/5'>
  ...
  <div className='flex gap-4 text-sm my-4 z-10'>
  ...
  <div className='w-2/5 h-[150vh] z-10 overflow-y-hidden overflow-x-auto flex justify-center items-center'>
  <Spline 
