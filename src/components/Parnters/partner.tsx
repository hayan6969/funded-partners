...
function Partner() {
  return (
    <section className='w-screen relative bg-[#080808]  px-24 max-md:px-6 max-lg:px-12 max-sm:px-1 py-24 flex flex-col gap-12 before:absolute before:w-full before:h-full before:bg-[#151414] before:opacity-80 before:left-0 before:top-0'>
      {/* -------------------------------------------------| Why Funded Partners |-------------------------------------------------- */}
      ...
      <div className='w-full h-full flex max-lg:flex-col-reverse gap-4 z-10'>
        <div className='w-full h-full flex flex-col gap-4'>
            ...
            <div className='w-full bg-white rounded-xl bg-gradient-to-b from-[#2A2B28] to-[#1D1828] flex flex-col p-6 gap-6 justify-between text-white max-lg:items-center'>
                <h5 className='text-3xl w-full'>Instant Funding</h5>
            ...
            <div className='w-full bg-white rounded-xl bg-gradient-to-b from-[#535BF5] to-[#8248A3] flex flex-col p-6 gap-6 text-white justify-between'>
              <div className='w-full flex justify-center max-lg:justify-start'>
...
<Pricing/>
      {/* -------------------------------------------------| Guaranteed Reward |-------------------------------------------------- */}
      <div className='w-full py-10 px-10  bg-[#FFFFFF1F] text-white rounded-xl flex max-lg:flex-col-reverse justify-between items-center relative before:absolute before:w-96 before:h-96 before:bg-[#3305FF] before:bg-opacity-10 before:rounded-full before:blur-3xl before:-left-20 before:-top-60 after:absolute after:w-96 after:h-96 after:bg-[#9CF05C]  after:bg-opacity-10 after:rounded-full  after:blur-3xl after:bottom-0 after:-right-20' style={{"backdropFilter":"blur(10px)"}}>
        <div className='flex flex-col gap-3 w-1/2 max-lg:w-full max-lg:text-center h-full z-10 justify-center'>
        ...
        <div className='w-1/3 max-lg:w-full flex z-10 p-0 pl-20 pb-10 item-start max-lg:pl-0 max-lg:justify-center'>
            <img src="./medal.gif" alt="" className='bounce-icon' />
        </div>
      </div>
      {/* -------------------------------------------------| Join Our Discord Community |-------------------------------------------------- */}
      <div className='w-full py-12 px-10 bg-[#FFFFFF1F] text-white rounded-xl flex max-lg:flex-col-reverse justify-between items-center max-lg:text-center relative ' style={{"backdropFilter":"blur(10px)"}}>
        <div className='w-1/3 max-lg:w-1/2 max-sm:w-2/3 flex justify-center'>
            <Image src="./Discord.svg" alt="Discord svg" width={614} height={614} />
        </div>
        <div className='flex flex-col gap-6 w-1/2 max-lg:w-full h-full z-10'>
            <div className='flex flex-col gap-3'>
